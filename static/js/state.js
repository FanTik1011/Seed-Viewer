...
const els = {
  ...
  finderBiomeList: document.getElementById("finder-biome-list"),
  finderStructureList: document.getElementById("finder-structure-list"),
  finderRadius: document.getElementById("finder-radius-input"),
  finderAttempts: document.getElementById("finder-attempts-select"),
  finderBiomeFilter: document.getElementById("finder-biome-filter"),
  finderStructureFilter: document.getElementById("finder-structure-filter"),
  finderSummary: document.getElementById("finder-summary"),
  finderRadiusPresets: document.getElementById("finder-radius-presets"),
